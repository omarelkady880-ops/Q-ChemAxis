...
const { setupTestUser } = require('./auto-setup-user');
...
// Start server and setup test user
async function startServer() {
  try {
    // Setup test user before starting server
    ...
    app.listen(PORT, () => {
      ...
      console.log(`🚀 [SERVER] Test user ready: omarelkady880@gmail.com / 66276627`);
    });
  } catch (error) {
